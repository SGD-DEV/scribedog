...
const MATERIAL_ICONS: Record<string, IconData> = {
  home: {
    viewBox: "0 0 24 24",
...
export function MaterialIcon({ name, size = 24, className = "", style }: MaterialIconProps) {
...
export const AVAILABLE_ICONS = Object.keys(MATERIAL_ICONS);
